...
def create_counter_function(sender, using, **kwargs):
    ...
    try:
        ...
        # TODO: This catch is a temporary hack. After upgrading Django, we sometimes get a
        # concurrency exception here when testing. We need another way to treat the project counter
        pass
