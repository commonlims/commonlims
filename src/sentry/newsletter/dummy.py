...
class NewsletterSubscription(object):
    def __init__(self, user, list_id, list_name=None, list_description=None, email=None,
                 verified=None, subscribed=False, subscribed_date=None, unsubscribed_date=None, **kwargs):
        ...
        self.verified = UserEmail.get_primary_email(
            user).is_verified if verified is None else verified
    ...
    def update(self, verified=None, subscribed=None,
    ...
    def update_subscription(self, user, list_id=None, create=False, **kwargs):
        ...
        if create:
            self._subscriptions[user].setdefault(
                list_id, NewsletterSubscription(
                    user, list_id, subscribed=True))
