...
import GroupChart from 'app/components/samples/groupChart';
import GroupCheckBox from 'app/components/samples/groupCheckBox';
...
const SamplesGroup = createReactClass({
  displayName: 'SamplesGroup',
