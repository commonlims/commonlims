...
const OrganizationDetailsLayout = createReactClass({
  displayName: 'OrganizationDetailsLayout',
...
export {OrganizationDetailsLayout};
export default withRouter(withEnvironment(OrganizationDetailsLayout));
