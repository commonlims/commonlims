...
import ProcessesActions from 'app/views/userTask/actions';
import ProcessesFilters from 'app/views/userTask/filters';
import ProcessesGroup from 'app/components/userTask/group';
import ProcessesSidebar from 'app/views/userTask/sidebar';
