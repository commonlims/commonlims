...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserTaskAssignee.project'
        db.delete_column('sentry_usertaskasignee', 'project_id')

        # Adding field 'UserTaskAssignee.organization'
        db.add_column('sentry_usertaskasignee', 'organization',
                      self.gf('sentry.db.models.fields.foreignkey.FlexibleForeignKey')(
                          default=1, related_name='assignee_set', to=orm['sentry.Organization']),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'UserTaskAssignee.project'
        db.add_column('sentry_usertaskasignee', 'project',
                      self.gf('sentry.db.models.fields.foreignkey.FlexibleForeignKey')(
                          default=1, related_name='assignee_set', to=orm['sentry.Project']),
                      keep_default=False)

        # Deleting field 'UserTaskAssignee.organization'
        db.delete_column('sentry_usertaskasignee', 'organization_id')
    ...
    models = {
        ...
        'sentry.activityinstance': {
            'Meta': {'object_name': 'ActivityInstance'},
            'external_id': ('django.db.models.fields.TextField', [], {}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'sample': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.Sample']"}),
            'user_task': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.UserTask']"})
        },
        'sentry.apiapplication': {
            'Meta': {'object_name': 'ApiApplication'},
            'allowed_origins': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'93dd4cd2918948f8a3389182e58269d7945babcb3da24157b7c1113a7f4709fa'", 'unique': 'True', 'max_length': '64'}),
            'client_secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'9d4777d7d9bd42fd97a9bb9581d12d1d1f029eaba010452abe8faf1fcdd53f8a'"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'homepage_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Saved Pig'", 'max_length': '64', 'blank': 'True'}),
        ...
        'sentry.apigrant': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'2fb9a56d0b354610a164c5c446a0bd24'", 'max_length': '64', 'db_index': 'True'}),
            'expires_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 3, 17, 0, 0)', 'db_index': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.apitoken': {
            ...
            'application': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.ApiApplication']", 'null': 'True'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'expires_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 4, 16, 0, 0)', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'default': "'073fd56d522c4146a6bd0fae80553a84ae9a6e299ad845dd9f17332ed330aa68'", 'max_length': '64', 'unique': 'True', 'null': 'True'}),
            'scope_list': ('sentry.db.models.fields.array.ArrayField', [], {'of': (u'django.db.models.fields.TextField', [], {})}),
            'scopes': ('django.db.models.fields.BigIntegerField', [], {'default': 'None'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'aaa63f76805c46f89246c77c1c7630372bdf2a3f4a394a269391690f25dcf6af'", 'unique': 'True', 'max_length': '64'}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']"})
        },
        ...
        'sentry.broadcast': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 3, 24, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.groupassignee': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'group': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'related_name': "'assignee_set1'", 'unique': 'True', 'to': "orm['sentry.Group']"}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'project': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'related_name': "'assignee_set1'", 'to': "orm['sentry.Project']"}),
            'team': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'related_name': "'sentry_assignee_set1'", 'null': 'True', 'to': "orm['sentry.Team']"}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'related_name': "'sentry_assignee_set1'", 'null': 'True', 'to': "orm['sentry.User']"})
        },
        ...
        'sentry.groupshare': {
            ...
            'project': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.Project']"}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']", 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e75ea68309c6455cb01a39c830dc3de1'", 'unique': 'True', 'max_length': '32'})
        },
        'sentry.groupsnooze': {
        ...
        'sentry.sample': {
            ...
            'concentration': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'custom_fields': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'depth': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'parents': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'parents_rel_+'", 'to': "orm['sentry.Sample']"}),
            'project': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'related_name': "'samples'", 'null': 'True', 'to': "orm['sentry.Project']"}),
            'type': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'version': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'volume': ('django.db.models.fields.FloatField', [], {'null': 'True'})
        },
        'sentry.savedsearch': {
        ...
        'sentry.scheduleddeletion': {
            ...
            'data': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_scheduled': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 4, 16, 0, 0)'}),
            'guid': ('django.db.models.fields.CharField', [], {'default': "'5775487a0bbe4ac393529acb149a531a'", 'unique': 'True', 'max_length': '32'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.sentryapp': {
            ...
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6abbd92c-f84d-4f1e-a3ee-2b333afc01a5'", 'max_length': '64'}),
        ...
        'sentry.sentryappinstallation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ca5670bd-a85e-4177-9443-f3ef68cd45b5'", 'max_length': '64'})
        },
        'sentry.servicehook': {
            ...
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'project_id': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'db_index': 'True'}),
            'secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'fb7a5f1f86b94faeadf9a7e2f7ce6e68cbe2f736351d461b8807384ad9c01791'"}),
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
        ...
        'sentry.useremail': {
            ...
            'validation_hash': ('django.db.models.fields.CharField', [], {'default': "u'Detdi5hpfJnTgihoLki2tQcGZ9WaKHI7'", 'max_length': '32'})
        },
        'sentry.userip': {
        ...
        'sentry.usertask': {
            ...
            'extra_fields': ('django.db.models.fields.TextField', [], {}),
            'handler': ('django.db.models.fields.TextField', [], {}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.usertaskassignee': {
            'Meta': {'object_name': 'UserTaskAssignee', 'db_table': "'sentry_usertaskasignee'"},
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'organization': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'related_name': "'assignee_set'", 'to': "orm['sentry.Organization']"}),
            ...
            'user_task': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'related_name': "'assignee_set'", 'unique': 'True', 'to': "orm['sentry.UserTask']"})
        },
        'sentry.usertaskfile': {
            'Meta': {'unique_together': "(('user_task', 'ident'),)", 'object_name': 'UserTaskFile', 'index_together': "(('user_task', 'name'),)"},
            'file': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.File']"}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'ident': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'name': ('django.db.models.fields.TextField', [], {}),
        ...
        'sentry.usertasksubscription': {
            'Meta': {'unique_together': "(('user_task', 'user'),)", 'object_name': 'UserTaskSubscription'},
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'reason': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0'}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']"}),
            'user_task': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'related_name': "'subscription_set'", 'to': "orm['sentry.UserTask']"})
        },
        'sentry.widget': {
