...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'UserTaskActivity'
        db.delete_table(u'sentry_usertaskactivity')

        # Adding model 'UserTaskSubscription'
        db.create_table('sentry_usertasksubscription', (
            ('id', self.gf('sentry.db.models.fields.bounded.BoundedBigAutoField')(primary_key=True)),
            ('user_task', self.gf('sentry.db.models.fields.foreignkey.FlexibleForeignKey')(
                related_name='subscription_set', to=orm['sentry.UserTask'])),
        ...
        db.send_create_signal('sentry', ['UserTaskSubscription'])

        # Adding unique constraint on 'UserTaskSubscription', fields ['user_task', 'user']
        db.create_unique('sentry_usertasksubscription', ['user_task_id', 'user_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'UserTaskSubscription', fields ['user_task', 'user']
        db.delete_unique('sentry_usertasksubscription', ['user_task_id', 'user_id'])

        # Adding model 'UserTaskActivity'
        db.create_table(u'sentry_usertaskactivity', (
            ('user_task', self.gf('sentry.db.models.fields.foreignkey.FlexibleForeignKey')(
        ...
        db.send_create_signal('sentry', ['UserTaskActivity'])

        # Deleting model 'UserTaskSubscription'
        db.delete_table('sentry_usertasksubscription')
    ...
    models = {
        ...
        'sentry.apiapplication': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'1a18accc61ac4e339e5438753a79f56da20863bdc2944ab7a48be56a1c6dbbd3'", 'unique': 'True', 'max_length': '64'}),
            'client_secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'3c7a7b49ab644efa9e11265d5c5b499e75e93197d9de403583cf2fff7c4f729f'"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'homepage_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Verified Labrador'", 'max_length': '64', 'blank': 'True'}),
        ...
        'sentry.apigrant': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'b9df0b2538d94d2ab47b5972759f7b4f'", 'max_length': '64', 'db_index': 'True'}),
        ...
        'sentry.apitoken': {
            ...
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'default': "'79444f9e3f734f06b3a03b92065203804129665ad78a41e9adae460ae33751c2'", 'max_length': '64', 'unique': 'True', 'null': 'True'}),
            'scope_list': ('sentry.db.models.fields.array.ArrayField', [], {'of': (u'django.db.models.fields.TextField', [], {})}),
            'scopes': ('django.db.models.fields.BigIntegerField', [], {'default': 'None'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'dc8708c5a6bb4651bdce1b701a76c1602860ec26d0a943b58e81bd7083c19a92'", 'unique': 'True', 'max_length': '64'}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']"})
        },
        ...
        'sentry.groupshare': {
            ...
            'project': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.Project']"}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']", 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'faca815ab4b440d6b5c8c75315514b23'", 'unique': 'True', 'max_length': '32'})
        },
        'sentry.groupsnooze': {
        ...
        'sentry.scheduleddeletion': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'cc5703f5c21b4634a0ce7bd4b8946faf'", 'unique': 'True', 'max_length': '32'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.sentryapp': {
            ...
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4bfa55b1-b1aa-4d14-a7a2-138d7197f8d8'", 'max_length': '64'}),
        ...
        'sentry.sentryappinstallation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0a3552d7-6138-4c8b-ad5a-e7d7c7577943'", 'max_length': '64'})
        },
        'sentry.servicehook': {
            ...
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'project_id': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'db_index': 'True'}),
            'secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'d37904247c0f49bbb12ad8d0fe2a5ed737b5e881dd9848ae841f4bb2c1bc4f40'"}),
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
        ...
        'sentry.useremail': {
            ...
            'validation_hash': ('django.db.models.fields.CharField', [], {'default': "u'PEeeDWPvcEDHz4bW0v4UhAalaP7vZRHY'", 'max_length': '32'})
        },
        'sentry.userip': {
