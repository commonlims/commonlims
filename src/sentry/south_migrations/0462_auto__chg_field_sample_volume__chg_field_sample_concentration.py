...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field parents on 'Sample'
        m2m_table_name = db.shorten_name('sentry_sample_parents')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_sample', models.ForeignKey(orm['sentry.sample'], null=False)),
            ('to_sample', models.ForeignKey(orm['sentry.sample'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_sample_id', 'to_sample_id'])

        # Changing field 'Sample.volume'
        db.alter_column('sentry_sample', 'volume', self.gf(
            'django.db.models.fields.FloatField')(null=True))

        # Changing field 'Sample.concentration'
        db.alter_column('sentry_sample', 'concentration', self.gf(
            'django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):
        # Removing M2M table for field parents on 'Sample'
        db.delete_table(db.shorten_name('sentry_sample_parents'))
    ...
    models = {
        ...
        'sentry.apiapplication': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'1e90ff492b1c453c95633034b90b4a071f074b9259014496a40e0862a0bbd5bc'", 'unique': 'True', 'max_length': '64'}),
            'client_secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'7e4c456dedc84d14bd2f070eaa5c4ca0e49e7378750d4cb992396a9cfb48fcc4'"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'homepage_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Engaging Ewe'", 'max_length': '64', 'blank': 'True'}),
        ...
        'sentry.apigrant': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'95dd65c3c1b1400e8b60c288233aacb3'", 'max_length': '64', 'db_index': 'True'}),
        ...
        'sentry.apitoken': {
            ...
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'default': "'f12e4f61500042e685b4f7553ff61e1482de33661a8149f59408a927d8d96180'", 'max_length': '64', 'unique': 'True', 'null': 'True'}),
            'scope_list': ('sentry.db.models.fields.array.ArrayField', [], {'of': (u'django.db.models.fields.TextField', [], {})}),
            'scopes': ('django.db.models.fields.BigIntegerField', [], {'default': 'None'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'5e57eb415b6a4f458a431ba8326f464060a458894b78451287b21c2ce5812bfe'", 'unique': 'True', 'max_length': '64'}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']"})
        },
        ...
        'sentry.groupshare': {
            ...
            'project': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.Project']"}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']", 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5c0a0c16a647418097690355ed69bb51'", 'unique': 'True', 'max_length': '32'})
        },
        'sentry.groupsnooze': {
        ...
        'sentry.scheduleddeletion': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'c5bdd7992b7d47b89036ad69cf775120'", 'unique': 'True', 'max_length': '32'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.sentryapp': {
            ...
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'449bcfb7-264d-42a0-a846-3f84d0f410cc'", 'max_length': '64'}),
        ...
        'sentry.sentryappinstallation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a7d7fa78-28e2-447c-87f2-387940057072'", 'max_length': '64'})
        },
        'sentry.servicehook': {
            ...
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'project_id': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'db_index': 'True'}),
            'secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'13240538f7b94a048e313c37a628bd58ffa8a22a41cb42b4a4d256820fe88a21'"}),
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
        ...
        'sentry.useremail': {
            ...
            'validation_hash': ('django.db.models.fields.CharField', [], {'default': "u'e6Ved4yorLAzTkQ8lPIuWieYxOohUFCr'", 'max_length': '32'})
        },
        'sentry.userip': {
