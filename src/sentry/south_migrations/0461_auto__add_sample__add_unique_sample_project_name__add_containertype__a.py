...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Sample'
        db.create_table('sentry_sample', (
            ('id', self.gf('sentry.db.models.fields.bounded.BoundedBigAutoField')(primary_key=True)),
            ('project', self.gf('sentry.db.models.fields.foreignkey.FlexibleForeignKey')(
                related_name='samples', null=True, to=orm['sentry.Project'])),
            ('name', self.gf('django.db.models.fields.TextField')(null=True)),
            ('type', self.gf('django.db.models.fields.TextField')(null=True)),
            ('concentration', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('volume', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('custom_fields', self.gf('django.db.models.fields.TextField')(null=True)),
            ('depth', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('sentry', ['Sample'])

        # Adding unique constraint on 'Sample', fields ['project', 'name']
        db.create_unique('sentry_sample', ['project_id', 'name'])

        # Adding model 'ContainerType'
        db.create_table('sentry_container_type', (
            ('id', self.gf('sentry.db.models.fields.bounded.BoundedBigAutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')(null=True)),
            ('rows', self.gf('django.db.models.fields.IntegerField')()),
            ('cols', self.gf('django.db.models.fields.IntegerField')()),
            ('levels', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('sentry', ['ContainerType'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'Sample', fields ['project', 'name']
        db.delete_unique('sentry_sample', ['project_id', 'name'])

        # Deleting model 'Sample'
        db.delete_table('sentry_sample')

        # Deleting model 'ContainerType'
        db.delete_table('sentry_container_type')
    ...
    models = {
        ...
        'sentry.apiapplication': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'7270104031314e3fb3cc02fca5a30df8b083e13c782a48fa9e7217d4bb7e9683'", 'unique': 'True', 'max_length': '64'}),
            'client_secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'6e8ad8233eaa4d58bc546571655079df0483e3148aec4dcc8890e9f947d5b163'"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'homepage_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Big Jackass'", 'max_length': '64', 'blank': 'True'}),
        ...
        'sentry.apigrant': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'a0ebcec457ee4eb6a7005ecbdf8a37e2'", 'max_length': '64', 'db_index': 'True'}),
        ...
        'sentry.apitoken': {
            ...
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'default': "'19ab9bdda9d244e08776e2cce80e3044d582005bb7cd4f539107a7a7370f9173'", 'max_length': '64', 'unique': 'True', 'null': 'True'}),
            'scope_list': ('sentry.db.models.fields.array.ArrayField', [], {'of': (u'django.db.models.fields.TextField', [], {})}),
            'scopes': ('django.db.models.fields.BigIntegerField', [], {'default': 'None'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'2a0d2c1be99b415a992c243d3cc1db27bd13fb3118994680888c322a93cbc78d'", 'unique': 'True', 'max_length': '64'}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']"})
        },
        ...
        'sentry.groupshare': {
            ...
            'project': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.Project']"}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']", 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d5f74be9449c43139dcbfc6b7a9db744'", 'unique': 'True', 'max_length': '32'})
        },
        'sentry.groupsnooze': {
        ...
        'sentry.sample': {
            ...
            'concentration': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
        ...
        'sentry.scheduleddeletion': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'b4a1a9364f7b48dbb033efd69558874b'", 'unique': 'True', 'max_length': '32'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.sentryapp': {
            ...
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'1b6b7c3c-04b9-4192-9e2f-ce01122dc74d'", 'max_length': '64'}),
        ...
        'sentry.sentryappinstallation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'94e876aa-25bc-42c9-8a25-5a183ebf7b1a'", 'max_length': '64'})
        },
        'sentry.servicehook': {
            ...
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'project_id': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'db_index': 'True'}),
            'secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'07d5fae1cc46434c93f3e87e610ea3a21039592b176b4fe2ab834fbf1fb5cb67'"}),
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
        ...
        'sentry.useremail': {
            ...
            'validation_hash': ('django.db.models.fields.CharField', [], {'default': "u'wLO7AhIQVPugDR6CfOO9aPfhPfuTnaXx'", 'max_length': '32'})
        },
        'sentry.userip': {
