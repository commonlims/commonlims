...
class ProjectPropertyEndpoint(OrganizationEndpoint):
    ...
    def get(self, request, organization, prop):
        ...
        if unique:
            unique_values_of_prop = self.app.projects.get_unique_values_of_property(property=prop)
            ...
            values_of_prop = self.app.projects.get_values_of_property(property=prop)
            return self.paginate(
                request=request,
