...
class ExtensibleServiceAPIMixin(object):
    ...
    def all(self):
        ...
        # TODO-nomerge: The `to_wrapper` method is NOT on this mixin, which makes this difficult to reason
        # about and error-prone, refactor
        return ResultIterator(self._all_qs(), self.to_wrapper)

    def _all_qs(self):
        """Returns a django queryset for all extensible of a particular version or latest if nothing
        is supplied
        """
    ...
    def search(self, search_string):
        ...
        # NOTE (again) the to_wrapper method isn't in the mixin!! nomerge
    ...
    def _search_qs(self, query):
        ...
        qs = self._archetype_version_model_class.objects.filter(
    ...
    def filter(self, **kwargs):
        ...
        qs = self._archetype_version_model_class.objects.prefetch_related(
