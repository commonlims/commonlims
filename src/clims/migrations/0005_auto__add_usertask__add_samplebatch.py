...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('clims_usertask', (
            ('id', self.gf('sentry.db.models.fields.bounded.BoundedBigAutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('sample_batch', self.gf('sentry.db.models.fields.foreignkey.FlexibleForeignKey')(
                to=orm['clims.SampleBatch'])),
        ))
        db.send_create_signal('clims', ['UserTask'])

        # Adding model 'SampleBatch'
        db.create_table('clims_samplebatch', (
            ('id', self.gf('sentry.db.models.fields.bounded.BoundedBigAutoField')(primary_key=True)),
        ))
        db.send_create_signal('clims', ['SampleBatch'])

    def backwards(self, orm):
        # Deleting model 'UserTask'
        db.delete_table('clims_usertask')

        # Deleting model 'SampleBatch'
        db.delete_table('clims_samplebatch')
