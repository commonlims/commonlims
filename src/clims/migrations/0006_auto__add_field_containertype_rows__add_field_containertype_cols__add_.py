...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContainerType.rows'
        db.add_column('clims_container_type', 'rows',
                      self.gf('django.db.models.fields.IntegerField')(default=12),
                      keep_default=False)

        # Adding field 'ContainerType.cols'
        db.add_column('clims_container_type', 'cols',
                      self.gf('django.db.models.fields.IntegerField')(default=8),
                      keep_default=False)

        # Adding field 'ContainerType.levels'
        db.add_column('clims_container_type', 'levels',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ContainerType.rows'
        db.delete_column('clims_container_type', 'rows')

        # Deleting field 'ContainerType.cols'
        db.delete_column('clims_container_type', 'cols')

        # Deleting field 'ContainerType.levels'
        db.delete_column('clims_container_type', 'levels')
    ...
    models = {
        ...
        'clims.usertask': {
            ...
            'sample_batch': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['clims.SampleBatch']"})
        },
        'sentry.organization': {
