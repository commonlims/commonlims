...
class ProjectOwnershipEndpointTestCase(APITestCase):
    ...
    def test_invalid_email(self):
        ...
        assert resp.status_code == 400
        assert resp.content == '{"non_field_errors":["Invalid rule owners: idont@exist.com"]}'
    ...
    def test_invalid_team(self):
        ...
        assert resp.status_code == 400
        assert resp.content == '{"non_field_errors":["Invalid rule owners: #faketeam"]}'
    ...
    def test_invalid_mixed(self):
        ...
        assert resp.status_code == 400
        assert resp.content == '{"non_field_errors":["Invalid rule owners: idont@exist.com, #faketeam"]}'
